...
import com.example.hammami.adapters.ReviewsAdapter
...
class ServiceDetailFragment : Fragment() {
    ...
    // private val viewPagerAdapter by lazy { ViePager2Images() } //per ora tolgo perchè non serve poi vediamo
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            if(service.reviews.isNullOrEmpty()) {
                tvTitoloRecensioni.visibility = View.GONE
                rvRecensioni.visibility = View.GONE
            }

            if(service.benefits.isNullOrEmpty()) {
